...
-- Empty-DB order: schema.sql → seed.sql → policies.sql → storage.sql → migrations
...
-- Generic audit writer used by billing/governance migrations (also defined later
-- in 20260531240000 / 20260531250000 via CREATE OR REPLACE).
