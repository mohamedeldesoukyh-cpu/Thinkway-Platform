...
| Deliverable status flow | §22.2 | ⚠️ Basic status update; no revision/version thread |
...
| Knowledge Gateway (AI consumption layer — design) | `docs/KNOWLEDGE_GATEWAY_CONSUMPTION_ARCHITECTURE.md` |
