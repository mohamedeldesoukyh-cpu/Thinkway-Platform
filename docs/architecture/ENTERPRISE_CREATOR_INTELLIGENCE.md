...
**Status:** **Maintenance Mode · frozen · protected · COMPLETE** — Release 2.3 Phase 1  
**Acceptance:** [`ENTERPRISE_CREATOR_INTELLIGENCE_ACCEPTANCE.md`](./ENTERPRISE_CREATOR_INTELLIGENCE_ACCEPTANCE.md) — **ACCEPTED**  
...
**Active initiative:** Planning Workspace (must consume this SSOT)  
