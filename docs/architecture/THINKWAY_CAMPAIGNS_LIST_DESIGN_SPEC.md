...
**Repo reference (canonical for list):** `docs/architecture/campaigns-list.html` · applied via
`.campaigns-list-suite` + `app/styles/campaigns-list-suite.css` on `/campaigns`.
...
## 11. Known production faults this design corrects
