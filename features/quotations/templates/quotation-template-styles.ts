...
export const QUOTATION_TEMPLATE_STYLES = `
  :root{
    --blue:#0057ff; --blue2:#3f7bff; --deep:#003bd0;
    --navy:#0d1836; --ink:#0d1220;
    --muted:#7c88a4; --muted2:#9aa3b5;
  ...
  *{box-sizing:border-box;}
  ...
  body.quotation-export-preview{background:#c9d4e8; padding:28px 0 40px;}
  ...
  .chip{
    ...
    color:#fff; border:1px solid rgba(255,255,255,.35); padding:6px 12px; border-radius:999px;
    background:rgba(255,255,255,.08); white-space:nowrap;
  }
  .cover .kicker, .cpage.grad .kicker{
    font-size:11px; font-weight:700; letter-spacing:.18em; text-transform:uppercase;
    color:#cbdcff; margin:28px 0 0;
  }
  .cover h1, .cpage.grad h1{
    font-size:36px; line-height:1.12; font-weight:800; letter-spacing:-1px;
    margin:12px 0 10px; max-width:28ch; color:#fff;
  }
  .cover .sub, .cpage.grad .sub{
    font-size:14px; color:rgba(255,255,255,.88); margin:0; max-width:58ch; line-height:1.5;
  }
  .metagrid{
  ...
  .stat .sl{font-size:10px; letter-spacing:.12em; text-transform:uppercase; color:#bfd2ff; margin:0 0 8px;}
  .stat .sv{font-size:28px; font-weight:800; letter-spacing:-.8px; color:#fff; margin:0; line-height:1.1;}
  .stat .su{font-size:12px; color:#c9dbff; margin:6px 0 0;}
  .cover .foot, .cpage.grad .foot{color:rgba(255,255,255,.72);}
  ...
  .insight p{font-size:12px; line-height:1.55; color:#3a4363; margin:0;}
  ...
  .fees table{width:100%; border-collapse:collapse; background:#fff; border:1px solid var(--border); border-radius:12px; overflow:hidden;}
  .fees thead th{
    font-size:9.5px; letter-spacing:.08em; text-transform:uppercase; color:var(--muted);
  ...
  .collap-package-card{border:1px solid var(--border); border-radius:12px; overflow:hidden; background:#fff;}
  ...
  .collap-creator-section{padding:12px 16px 16px; background:#fbfcff;}
  ...
  .collap-creator-card{border:1px solid var(--border); border-radius:12px; padding:12px; background:#fff;}
  .collap-creator-head{display:flex; align-items:flex-start; gap:10px; margin-bottom:8px;}
  .collap-creator-avatar{width:40px; height:40px; border-radius:999px; flex:none; display:flex; align-items:center; justify-content:center; font-size:13px; font-weight:800; color:#fff; background:linear-gradient(145deg,#178f69 0%,var(--tw-green) 100%); overflow:hidden;}
  ...
  .quotation-platform-icon-fallback{display:inline-flex; align-items:center; justify-content:center; width:18px; height:18px; border-radius:50%; background:#F3F4F6; color:#6B7280; font-size:8px; font-weight:700; flex:none;}
