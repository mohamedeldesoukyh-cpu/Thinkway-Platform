...
type Props = {
  report: Pick<
    VrReportData,
    "year" | "period_scope" | "display_currency" | "available_currencies" | "client_type"
  >;
};
...
export function VrReportControls({ report }: Props) {
    ...
    >
      <div className="flex flex-wrap items-end gap-3">
        ...
        <div className="ml-auto">
          <ReportExportActions apiPath="/api/reports/vr/document" />
        </div>
      </div>
    </div>
  );
