...
import { TOP_CLIENTS_LIMIT_OPTIONS } from "@/lib/analytics/top-clients/top-clients-types";
...
export function TopClientsControls({ report }: Props) {
    ...
    >
      <div className="flex flex-wrap items-end gap-3">
        ...
        <div className="grid min-w-[7rem] gap-1">
          ...
          <Select
            value={state.metric}
            onValueChange={(value) => apply({ metric: value as TopClientsMetric })}
          >
            <SelectTrigger className="h-8 w-[7rem] text-xs">
              <SelectValue />
            </SelectTrigger>
        ...
        <div className="grid min-w-[6rem] gap-1">
          ...
          <Select value={state.limit} onValueChange={(value) => apply({ limit: value })}>
            ...
            <SelectContent>
              {TOP_CLIENTS_LIMIT_OPTIONS.map((count) => (
        ...
        <div className="grid min-w-[7rem] gap-1">
          ...
          <Select
            ...
            onValueChange={(value) =>
              apply({ clientType: value as TopClientsClientTypeFilter })
            }
          >
            <SelectTrigger className="h-8 w-[7rem] text-xs">
              <SelectValue />
        ...
        <div className="ml-auto">
          <ReportExportActions apiPath="/api/reports/top-clients/document" />
        </div>
      </div>
    </div>
  );
