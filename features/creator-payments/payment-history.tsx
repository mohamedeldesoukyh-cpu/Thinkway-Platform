...
export function PaymentHistory({row,canWrite,onSaved}:{row:PaymentRow;canWrite:boolean;onSaved:()=>void}) {
    ...
    return <div className="cp-payment-history">
        {canWrite&&row.payable!==false&&<button className="cp-button" onClick={()=>setEditor({})}>+ Add payments</button>}
