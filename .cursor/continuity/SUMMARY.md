...
- `docs/architecture/ENTERPRISE_DOCUMENT_LIFECYCLE.md` — Enterprise Document Lifecycle Engine (`lib/document-lifecycle/`); R2.2d.2; Vendor/Client IO first; reason codes + business change events
