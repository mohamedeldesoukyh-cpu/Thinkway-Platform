...
- `docs/architecture/PLATFORM_CAPABILITY_REGISTRY.md` — permanent registry; Document Lifecycle + Change Impact + ECI + Studio Governance + **Campaign Script Phase 3 Internal UI** (`lib/campaign-script/`)
