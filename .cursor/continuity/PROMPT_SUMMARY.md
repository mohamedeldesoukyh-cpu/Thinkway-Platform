...
- **Quotation avatars:** Workspace enrich now uses DNA + durable storage (export-quality), persists recovered URLs, queues stabilize for missing; proxy negative-cache still allows profile warm; seeds prefer durable over expired CDN
