...
- **Deliverables redesign (proposal, no code):** Documentation & Asset Repository SSOT — not a workflow engine. Files/links/captions/versions/comments/audit only. Draft ≠ Publication/Performance. Media Plan avatar docs-completeness rings (distinct from Live/Partial). Spec: `docs/architecture/DELIVERABLES_DOCUMENTATION_REPOSITORY.md`. **Awaiting approval before implementation.**
