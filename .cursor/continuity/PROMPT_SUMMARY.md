...
- Upload logos on Group, Client, and Brand. Client Workspace header shows **group logo first**, then **client logo**, to the right of the Thinkway mark. Brand logos are stored but not used in that header.
