...
- **Deliverables Documentation Repository Phase 1 (in progress on develop):** Approved SSOT — docs/assets only. Decisions locked (qty grain, received=file/link, docs badge≠execution ring, no client/creator portal this phase). Migration `20260730120000` applied on **Dev**. Workspace + Media Plan docs badge. Spec: `docs/architecture/DELIVERABLES_DOCUMENTATION_REPOSITORY.md`. Tests: `npm run test:deliverable-docs`.
